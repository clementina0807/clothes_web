  ...
  <section id="product">
    <div class="flex">
      <div class="font-bold bg-background mr-10 ml-12 mt-12 underline underline-offset-2 leading-loose ">
        <ul>
        <li class="cursor-pointer">LADY</li></ul>
        <div class="font-bold bg-background  mt-4  leading-loose font-normal  text-sm ">
        <ul><li class="cursor-pointer" @click="getCategory('all')">SEP.24</li>
        <li class="cursor-pointer" @click="getCategory('hot')">SEP.16</li>
        <li class="cursor-pointer" @click="getCategory('featured')">SEP.10</li>
        <li class="cursor-pointer" @click="getCategory('global')">SEP.03</li></ul></div></div>
